...
RUNDIR=$SCRATCH/pa_${SLURM_JOBID/.*}_768_5832dd9_variable_r_lpa_20_dx_028mm_vessel_down10x_92168c6
mkdir $RUNDIR

# set up run info 
BASE_NAME=aortic_no_partition_384
BASE_NAME_VESSEL=vessel_768
INPUT_NAME=input_PA_box_tester_valve_768
RUN_LINE="mpiexec -report-bindings main_rv_pa"
...
cp run_PA_box_tester_768_expanse.sh   $RUNDIR
