...
scaling = 2
width = 640 * scaling
height_top_view = width
height_side_view = 2*width



# does not fix on output 
zoom_top_view = 0

# Create a new 'Render View'
renderView1 = CreateView('RenderView')
renderView1.ViewSize = [width, height_top_view]
renderView1.AxesGrid = 'GridAxes3DActor'
renderView1.OrientationAxesVisibility = 0
renderView1.CenterOfRotation = [0.0, 0.0, 0.75]
renderView1.StereoType = 'Crystal Eyes'

renderView1.CameraPosition = [0.0, 0.0, 25.008722343099873]
renderView1.CameraFocalPoint = [0.0, 0.0, 0.75]
...
# renderView1.CameraPosition = [-0.0118654110947045, 0.06453941407452532, 25.008722343099873 + zoom_top_view]
# renderView1.CameraFocalPoint = [-0.0118654110947045, 0.06453941407452532, 0.75 + zoom_top_view]
renderView1.CameraFocalDisk = 1.0
renderView1.CameraParallelScale = 2.1650035488494987 * .59
...
renderView2.ViewSize = [width, height_side_view]
renderView2.AxesGrid = 'GridAxes3DActor'
renderView2.OrientationAxesVisibility = 0
renderView2.CenterOfRotation = [0.0, -0.00016164779663085938, 0.5]
renderView2.StereoType = 'Crystal Eyes'
renderView2.CameraPosition = [0.0, -18.143050647253336 + zoom_side_view, 0.5]
renderView2.CameraFocalPoint = [0.0, 17.856788040611463 + zoom_side_view, 0.5]
...
#layout1.SplitVertical(0, 1080. / (1080. + 640.))
layout1.SplitVertical(0, 0.04 + 1080. / (1080. + 640.))
...
# create a new 'PVD Reader'
eulerian_varspvd_1 = PVDReader(FileName= path + 'eulerian_vars.pvd')
...
if save:
    ...
    # this makes the camera appear closer to the object but doesn't put the object in the screen 
    # Render()
    # cam = GetActiveCamera()
    # print "camera = ", cam 
    # print "dir(cam) = ", dir(cam)
    # cam.Dolly(1000)
    # print "called dolly"
    # print "dir(cam) = ", dir(cam)
    # Render()

    # totally unclear what this does 
    # Render()
