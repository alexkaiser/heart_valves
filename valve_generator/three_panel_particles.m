    ...
    for i=range
        ...
        if ((~exist(start_name, 'file')) && (~exist(end_name, 'file'))) || ...
           (cleanup                      && (~exist(end_name, 'file')))
            ...
            fig = plot_particles(file_name, max_velocity, fig, bounding_box, colorbar_figure, line_width_leaflet, line_width_tails, dot_size); 
