...
for leaflet_num = n_leaflets:-1:1
    for layer = n_layers:-1:1
        leaflets(layer, leaflet_num) = import_valve_from_csv(valve_with_reference, file_name, params.layer_indices(layer, leaflet_num).indices_global, data_dir, run_inv_transform); 
    end 
end 
