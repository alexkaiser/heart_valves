function [vertices normal centroid R] = coordinate_transformation_vertices(vertices, ring_boundary_file, R_0, T_0, normal_override, origin_override)
% 
...
if exist('normal_override', 'var') && exist('origin_override', 'var')
    if ~isempty(ring_boundary_file)
        warning('overriding normal and origin, ignoring boundary file'); 
    end 
    
    normal = normal_override; 
    centroid = origin_override; 
