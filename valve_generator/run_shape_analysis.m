...
%                     sprintf("_systole__layer_%d_%d", layer, idx_frames(4)-1)]; 
    ...
    %             free_edge_length_total 
                ...
                fprintf('%s & %s & %s & %s & ', names_struct(data_idx).circ_over_d, names_struct(data_idx).circ, names_struct(data_idx).rad, names_struct(data_idx).comment); 
